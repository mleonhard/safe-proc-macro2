...
fn test_proc_macro2_fallback_size_without_locations() {
    assert_eq!(mem::size_of::<safe_proc_macro2::Span>(), 0);
    assert_eq!(mem::size_of::<Option<safe_proc_macro2::Span>>(), 1);
    assert_eq!(mem::size_of::<safe_proc_macro2::Group>(), 16);
    assert_eq!(mem::size_of::<safe_proc_macro2::Ident>(), 24);
    assert_eq!(mem::size_of::<safe_proc_macro2::Punct>(), 8);
    assert_eq!(mem::size_of::<safe_proc_macro2::Literal>(), 24);
    assert_eq!(mem::size_of::<safe_proc_macro2::TokenStream>(), 8);
}
...
fn test_proc_macro2_fallback_size_with_locations() {
    assert_eq!(mem::size_of::<safe_proc_macro2::Span>(), 8);
    assert_eq!(mem::size_of::<Option<safe_proc_macro2::Span>>(), 12);
    assert_eq!(mem::size_of::<safe_proc_macro2::Group>(), 24);
    assert_eq!(mem::size_of::<safe_proc_macro2::Ident>(), 32);
    assert_eq!(mem::size_of::<safe_proc_macro2::Punct>(), 16);
    assert_eq!(mem::size_of::<safe_proc_macro2::Literal>(), 32);
    assert_eq!(mem::size_of::<safe_proc_macro2::TokenStream>(), 8);
}
...
fn test_proc_macro2_wrapper_size_without_locations() {
    assert_eq!(mem::size_of::<safe_proc_macro2::Span>(), 4);
    assert_eq!(mem::size_of::<Option<safe_proc_macro2::Span>>(), 8);
    assert_eq!(mem::size_of::<safe_proc_macro2::Group>(), 24);
    assert_eq!(mem::size_of::<safe_proc_macro2::Ident>(), 24);
    assert_eq!(mem::size_of::<safe_proc_macro2::Punct>(), 12);
    assert_eq!(mem::size_of::<safe_proc_macro2::Literal>(), 24);
    assert_eq!(mem::size_of::<safe_proc_macro2::TokenStream>(), 32);
}
...
fn test_proc_macro2_wrapper_size_with_locations() {
    assert_eq!(mem::size_of::<safe_proc_macro2::Span>(), 12);
    assert_eq!(mem::size_of::<Option<safe_proc_macro2::Span>>(), 12);
    assert_eq!(mem::size_of::<safe_proc_macro2::Group>(), 32);
    assert_eq!(mem::size_of::<safe_proc_macro2::Ident>(), 32);
    assert_eq!(mem::size_of::<safe_proc_macro2::Punct>(), 20);
    assert_eq!(mem::size_of::<safe_proc_macro2::Literal>(), 32);
    assert_eq!(mem::size_of::<safe_proc_macro2::TokenStream>(), 32);
}
